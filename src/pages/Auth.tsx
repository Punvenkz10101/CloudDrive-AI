...
const Auth = () => {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      const path = isSignIn ? '/auth/login' : '/auth/signup';
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-emerald-brand rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Cloud className="w-8 h-8 text-emerald-brand-foreground" />
            </div>
            <h1 className="text-2xl font-bold text-foreground">CloudDrive-AI</h1>
            <p className="text-muted-foreground mt-2">
              Secure cloud storage with AI intelligence
            </p>
          </div>
          ...
          <div className="text-center mt-8 text-xs text-muted-foreground">
            ...
            <a href="#" className="underline hover:text-foreground transition-smooth">
              Terms of Service
            </a>{' '}
            and{' '}
            <a href="#" className="underline hover:text-foreground transition-smooth">
